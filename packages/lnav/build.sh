...
TERMUX_PKG_DEPENDS="libandroid-spawn, libandroid-utimes, libarchive, libbz2, libc++, libcurl, libsqlite, libunistring, pcre2, readline, zlib"
...
termux_step_pre_configure() {
	...
	LDFLAGS+=" -landroid-spawn -landroid-utimes"
}
