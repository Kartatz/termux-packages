...
TERMUX_PKG_VERSION="2606"
TERMUX_PKG_SRCURL="https://gitlab.com/openfoam/core/openfoam/-/archive/OpenFOAM-v${TERMUX_PKG_VERSION}/openfoam-OpenFOAM-v${TERMUX_PKG_VERSION}.tar.bz2"
TERMUX_PKG_SHA256=b2973d33183906ec613c1a08ccf0dbe4e7c9ae3d1e5f6844fa2a729243a2c21b
TERMUX_PKG_DEPENDS="boost, libc++, libgmp, libmpfr, openmpi, readline, zlib"
TERMUX_PKG_BUILD_DEPENDS="boost-headers, cgal, flex"
